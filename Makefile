...
# Project:  PacMan.pro
# Template: app
# Command: /home/adrien/Qt/5.15.2/gcc_64/bin/qmake -o Makefile PacMan.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
INCPATH       = -I. -I../../../Qt/5.15.2/gcc_64/mkspecs/linux-g++
QMAKE         = /home/adrien/Qt/5.15.2/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /home/adrien/Qt/5.15.2/gcc_64/bin/qmake -install qinstall
QINSTALL_PROGRAM = /home/adrien/Qt/5.15.2/gcc_64/bin/qmake -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
...
DISTDIR = /home/adrien/devel/gitProjects/myPacman/.tmp/PacMan1.0.0
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS)    
AR            = ar cqs
...
SOURCES       = $(PATH)/src/Doc_Prof/game.cpp \
		$(PATH)/src/Doc_Prof/gridmanagement.cpp \
		$(PATH)/src/Doc_Prof/params.cpp \
		$(PATH)/src/EasterEggs.cpp \
		$(PATH)/src/map.cpp \
		$(PATH)/src/ove.cpp \
		$(PATH)/src/main.cpp 
		
OBJECTS       = .o/Doc_Prof/game.o \
		.o/Doc_Prof/gridmanagement.o \
		.o/Doc_Prof/params.o \
		.o/EasterEggs.o \
		.o/map.o \
		.o/move.o \
...
DIST          = config.yaml \
		...
		PacMan.pro $(PATH)/headers/Doc_Prof/game.h \
		$(PATH)/headers/Doc_Prof/gridmanagement.h \
		$(PATH)/headers/Doc_Prof/params.h \
		$(PATH)/headers/Doc_Prof/type.h \
		$(PATH)/headers/models.h $(PATH)/src/Doc_Prof/game.cpp \
		$(PATH)/src/Doc_Prof/gridmanagement.cpp \
		$(PATH)/src/Doc_Prof/params.cpp \
		$(PATH)/src/EasterEggs.cpp \
		$(PATH)/src/EasterEggs.cpp \
...
Makefile: PacMan.pro ../../../Qt/5.15.2/gcc_64/mkspecs/linux-g++/qmake.conf ../../../Qt/5.15.2/gcc_64/mkspecs/features/spec_pre.prf \
		../../../Qt/5.15.2/gcc_64/mkspecs/common/unix.conf \
		../../../Qt/5.15.2/gcc_64/mkspecs/common/linux.conf \
		../../../Qt/5.15.2/gcc_64/mkspecs/common/sanitize.conf \
		../../../Qt/5.15.2/gcc_64/mkspecs/common/gcc-base.conf \
		...
		../../../Qt/5.15.2/gcc_64/mkspecs/features/lex.prf \
		PacMan.pro
	$(QMAKE) -o Makefile PacMan.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
../../../Qt/5.15.2/gcc_64/mkspecs/features/spec_pre.prf:
../../../Qt/5.15.2/gcc_64/mkspecs/common/unix.conf:
../../../Qt/5.15.2/gcc_64/mkspecs/common/linux.conf:
../../../Qt/5.15.2/gcc_64/mkspecs/common/sanitize.conf:
...
game.o: $(PATH)/src/Doc_Prof/game.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .o/Doc_Prof/game.o $(PATH)/src/Doc_Prof/game.cpp

gridmanagement.o: $(PATH)/src/Doc_Prof/gridmanagement.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .o/Doc_Prof/gridmanagement.o $(PATH)/src/Doc_Prof/gridmanagement.cpp

params.o: $(PATH)/src/Doc_Prof/params.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .o/Doc_Prof/params.o $(PATH)/src/Doc_Prof/params.cpp

EasterEggs.o: $(PATH)/src/EasterEggs.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .o/EasterEggs.o $(PATH)/src/EasterEggs.cpp

map.o: $(PATH)/src/map.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .o/map.o $(PATH)/src/map.cpp

move.o: $(PATH)/src/move.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .o/move.o $(PATH)/src/move.cpp

main.o: $(PATH)/src/main.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .o/main.o $(PATH)/src/main.cpp
